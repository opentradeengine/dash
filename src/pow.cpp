...
unsigned int static DarkGravityWave(const CBlockIndex* pindexLast, const Consensus::Params& params) {
    /* current difficulty formula, digitalcoin - DarkGravity v3, written by Evan Duffield - evan@digitalcoin.org */
...
unsigned int GetNextWorkRequired_DASHVERSION(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
...
bool CheckProofOfWork(uint256 hash, unsigned int nBits, const Consensus::Params& params)
{
    ...
    if ((UintToArith256(hash) > (bnTarget))) //Le bon signe c'est >
    {
