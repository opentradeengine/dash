...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Digitalcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Digitalcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Digitalcoin Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Digitalcoin Core help message to get a list with possible Digitalcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Digitalcoin client") + " " + networkStyle->getTitleAddText();
