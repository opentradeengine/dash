    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Digitalcoin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Digitalcoin Core"));
...
All the Digitalcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://digitalcoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://digitalcoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Digitalcoin is shutting down...") + "<br /><br />" +
