...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Digitalcoin digitalcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  digitalcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded digitalcoin transaction") + "\n" +
              "  digitalcoin-tx [options] -create [commands]   " + _("Create hex-encoded digitalcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded digitalcoin transaction
