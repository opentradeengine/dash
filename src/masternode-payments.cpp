...
void FillBlockPayments(CMutableTransaction& txNew,CMutableTransaction& txNew2, int nBlockHeight, CAmount blockReward, CTxOut& txoutMasternodeRet, std::vector<CTxOut>& voutSuperblockRet)
{
    ...
    if(sporkManager.IsSporkActive(SPORK_9_SUPERBLOCKS_ENABLED) &&
        CSuperblockManager::IsSuperblockTriggered(nBlockHeight)) {
            ...
            CSuperblockManager::CreateSuperblock(txNew2, nBlockHeight, voutSuperblockRet);
            return;
    }
