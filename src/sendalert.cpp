...
2. run digitalcoind with -printalert or -sendalert like this:
   /path/to/digitalcoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.digitalcoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Digitalcoin Core:0.12.0.58/"));
