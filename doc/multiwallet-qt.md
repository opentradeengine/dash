...
Only requiring some minor changes is digitalcoin.cpp.
...
Changes to digitalcoin.cpp
----------------------
digitalcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
