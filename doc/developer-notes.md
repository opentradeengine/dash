...
Digitalcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Digitalcoin Core, where everyone uses
...
pay attention to for reviewers of Digitalcoin Core code.

General Digitalcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Digitalcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
