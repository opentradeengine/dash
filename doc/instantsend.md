...
This mechanism has been integrated into Bitcore-Node-Digitalcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/digitalcoinpay/insight-api-digitalcoin#web-socket-api](https://github.com/digitalcoinpay/insight-api-digitalcoin#web-socket-api)
* API: [https://github.com/digitalcoinpay/insight-api-digitalcoin#instantsend-transactions](https://github.com/digitalcoinpay/insight-api-digitalcoin#instantsend-transactions)
...
By default, the Digitalcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Digitalcoin Core daemon:
