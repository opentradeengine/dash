...
[From the digitalcoin github repo](https://github.com/digitalcoinpay/digitalcoin/blob/master/doc/masternode_conf.md)
...
## Update digitalcoin.conf on server

If you generated a new masternode private key, you will need to update the remote `digitalcoin.conf` files.

Shut down the daemon and then edit the file.

```nano .digitalcoin/digitalcoin.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `digitalcoin.conf` file.
...
and comparing with the official explorer at https://explorer.digitalcoin.org/chain/Digitalcoin
...
Search your Masternodes on https://digitalcoinninja.pl/masternodes.html
